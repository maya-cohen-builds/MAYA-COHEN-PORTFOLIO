...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Brand manager supporting Tracee Ellis Ross's press role in the Becoming campaign, including NYT interview prep with Michelle Obama.",
    tag: "Content",
