    ...
    >
      <div className="aspect-[16/9] overflow-hidden bg-muted mb-6 relative">
        <img
          ...
          alt={project.title}
          className={`w-full h-full transition-transform duration-700 group-hover:scale-105 ${project.cardImage ? `object-contain ${project.id === "pipex-virtual-launch" ? "bg-[#0a0a2e]" : "bg-[#8a9bb5]"}` : project.id === "becoming-memoir-launch" ? "object-cover object-[center_20%]" : "object-cover"}`}
          loading="lazy"
        />
