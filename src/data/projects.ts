...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Enabled the GTM launch of PATTERN Beauty in 2019, creating the messaging and positioning infrastructure and carving the brand foundation of award-winning actress and activist, Tracee Ellis Ross.",
    tag: "Content",
    ...
    impact: "Built and delivered the messaging frameworks, talking points, and media training materials that directly powered Tracee Ellis Ross's press appearances in the Becoming campaign, including her New York Times interview with Michelle Obama. Contributed to the brand voice and positioning work that preceded and enabled the 2019 PATTERN Beauty GTM launch. It achieved rapid success by selling out within hours of launch at Ulta Beauty, growing from 7 products to over 50. Supported Time's Up C-suite messaging that mobilized $21M in 60 days. Tracee Ellis Ross's Glamour speech went viral and led to TED2018. The Becoming LA Forum stop sold out 17,500 seats. Becoming sold 14M copies worldwide.",
