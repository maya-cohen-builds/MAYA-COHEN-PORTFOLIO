...
export const projects: Project[] = [
  ...
  },
  {
    ...
    impact: "Project managed 7+ fan conventions and 15 speaker appearances across 20+ regional markets and 10K+ attendees. The tour spanned 15+ cities across the US with multiple sold-out stops including Cambridge MA, Long Island NY, and Naperville IL. The memoir debuted as a New York Times Bestseller. The paperback release generated a second full tour leg in 2024, anchored by a stop at the Smithsonian Museum of Natural History in Washington DC. Oversaw press appearances across primetime, syndicated, and podcasting with direct producer responsibilities.",
