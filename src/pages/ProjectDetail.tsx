    ...
    <main className="bg-background min-h-screen">
      ...
      <div className="px-8 md:px-16 py-16 max-w-5xl">
        ...
        <div className="mt-24">
          ...
          <div className={`grid gap-4 ${project.id === "pipex-virtual-launch" ? "grid-cols-1" : project.id === "usc-marshall-gwib" ? "columns-1 md:columns-2 lg:columns-3 space-y-4 block" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3"}`}>
