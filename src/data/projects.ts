...
export const projects: Project[] = [
  {
    ...
    description: "Launched the world's first cloud-native animation pipeline featuring Trolls IP during peak pandemic Zoom fatigue.",
    tag: "Enterprise",
  ...
  },
  {
    ...
    role: "As Chief of Staff to Henry Winkler, I served as the operational and creative lead behind the tour's execution. I owned end-to-end logistics and travel coordination across all tour markets, managed talent scheduling and green room to stage management, led media prep and developed talking points used across press appearances, coordinated PR outreach and fan convention integrations, produced social content including on-camera video announcements for Winkler's speaker series, and contributed copyediting and ghostwriting to supporting materials for the book itself. I also produced a live virtual appearance for Access Hollywood in support of the book tour. I also produced a live video on X to celebrate 7,000 signed memoir copies.",
    impact: "Project managed 7+ fan conventions and 15 speaker appearances across 20+ regional markets and 10K+ attendees. The tour spanned 15+ cities across the US with multiple sold-out stops including Cambridge MA, Long Island NY, and Naperville IL. The memoir debuted as a New York Times Bestseller. The paperback release generated a second full tour leg in 2024, anchored by a stop at the Smithsonian Museum of Natural History in Washington DC. Oversaw press appearances across primetime, syndicated, and podcasting with direct producer responsibilities. Contributed direct copyediting, ghostwriting, and IP selection to the published draft of \"Being Henry.\"",
  ...
  },
  {
    ...
    role: "Leading executive communications for Tracee Ellis Ross, I built the positioning and messaging frameworks that anchored her role as a key press figure in the Becoming campaign. This included selecting and synthesizing thematic content from the memoir, structuring talking points, and developing media training materials used directly in her New York Times interview with Michelle Obama. I also advised on strategy and content for her Glamour Women of the Year speech, which went viral and led directly to her TED2018 invitation. Working sessions took place across Los Angeles including on the set of Black-ish. In parallel I supported the Time's Up movement at the C-suite level, converting live executive meeting notes into messaging and positioning frameworks for the GTM launch of their legal defense fund.",
    impact: "Built and delivered the messaging frameworks, talking points, and media training materials that directly powered Tracee Ellis Ross's press appearances in the Becoming campaign, including her New York Times interview with Michelle Obama. Contributed to the brand voice and positioning work that preceded and enabled the 2019 PATTERN Beauty GTM launch. Supported Time's Up C-suite messaging that mobilized $21M in 60 days. Tracee Ellis Ross's Glamour speech went viral and led to TED2018. The Becoming LA Forum stop sold out 17,500 seats. Becoming sold 14M copies worldwide.",
  ...
  },
  {
    ...
    description: "Integrated marketing manager overseeing digital marketing campaigns, live production, vendor coordination, real-time IT troubleshooting, and live social coverage at a Hollywood awards ceremony.",
    tag: "Live Events",
  ...
  },
  {
    ...
    description: "Elected organizing committee member who created the brand identity, oversaw brand partnership strategy, and emceed the full conference featuring the CFO of SKIMS.",
    tag: "Campus",
    image: elevateCover,
    context: "The USC Elevate Summit was the inaugural co-branded conference between USC GWIB's Elevate Her and Marshall Pride's Spotlight Summit, two distinct student organizations coming together for the first time to produce a unified brand experience. The event featured brand partnerships with Lo & Sons and Coca-Cola, keynote talent including the CFO of SKIMS and the Co-Founder and CEO of DRAFTED, and a community session spotlighting a student-led nonprofit.",
  ...
  },
  {
    ...
    gallery: [khGallery5, khGallery3, khGallery1, khCover],
  },
  {
