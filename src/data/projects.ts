...
export const projects: Project[] = [
  ...
  },
  {
    ...
    press: "PipelineX, the cloud-native production system underlying PipeX, was published at ACM SIGGRAPH DigiPro 2017, the premier peer-reviewed venue for production pipeline research, and cited again at DigiPro 2022 as a foundational industry reference. DreamWorks presented the system's evolution at the 2022 Pipeline Conference co-located with SIGGRAPH, and DreamWorks SVP-level representation of the work appeared at Web Summit 2021. The collaboration was covered on UX Planet, describing the challenge of building artist-friendly infrastructure to manage 500 million digital files across geographies. Enterprise architecture coverage appeared in CIO Magazine, citing DreamWorks' cloud-native, multi-tenant infrastructure as central to keeping production running through the pandemic. PipeX supported production on Trolls: Holiday in Harmony, which premiered on NBC primetime on November 26, 2021, the most recent DreamWorks Animation television special as of 2025, featuring Anna Kendrick and Justin Timberlake.",
  ...
  },
  {
    ...
    role: "As VP of Marketing I led a full brand refresh from the ground up, redesigning the brand guidelines and logo from scratch. I owned social media strategy, content creation, posting, and reels production end to end. I created the SpotlightHER campaign with original messaging and positioning collateral to showcase board members, developed decks for internal and external use, and mentored two members including an Associate VP and an undergraduate GWIB member. I secured and executed brand partnerships with the LA Sparks, Nike, Kiehl's, Pickle, and Lo & Sons, and produced activations across 15+ events including the LA Sparks Suite Night, Nike FitLab Workout and Mixer, Pickle Fashion Showcase, Tommy's Day of Fun Beach Day, Girls n' Gays Pride Picnic, Hate Your Headshot Re-Do, Women in Finance Panel, Women in Consulting Panel, MBA Open House, August Club Fair, Affinity Club Tailgate, Halloween, and Noodles Event.",
