    ...
    <section className="relative h-svh w-full flex flex-col justify-end p-8 md:p-16 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-5xl">
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-12">Product Marketing. Brand Activations. Let's build GTM experiences consumers remember.
