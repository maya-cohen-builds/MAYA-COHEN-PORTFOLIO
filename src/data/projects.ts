...
export const projects: Project[] = [
  ...
  },
  {
    ...
    press: "USC Elevate Summit, inaugural edition. Brand partners: Lo & Sons, Coca-Cola. Keynote: Andy Muir, CFO of SKIMS. Fireside chat: Karina Martinez, Co-Founder and CEO of DRAFTED. \"Maya's flavor of public speaking is unlike anything I've ever seen. She has all the makings of a confident and strategic thinker, but blends it with a background in stand-up comedy and public advocacy.\" John Shehan, Customer & Digital Strategy, Deloitte Consulting, LinkedIn Recommendation, August 2025. \n\n\n \"Out of all the speakers, I distinctly remember your part of the presentation around AI influencers. You did such a great job. Thank you for teaching me something new.\" Tomas Babucci, Manager, AI & Data Practice, Agentic AI, EY.",
