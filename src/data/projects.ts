...
export const projects: Project[] = [
  ...
  },
  {
    ...
    impact: "Grew social engagement and partnerships by 200% as a direct result of the brand overhaul, new visual identity system, and campaign programming. Delivered a complete brand identity overhaul including a new logo that became official organization collateral. Secured five brand partnerships and produced 15+ events serving 500+ members across all Marshall graduate programs. Mentored two emerging marketing professionals simultaneously while managing the full marketing function independently.",
    press: "USC Marshall Graduate Women in Business, VP of Marketing, class of 2026.",
